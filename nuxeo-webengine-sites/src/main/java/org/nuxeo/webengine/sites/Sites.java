...
public class Sites extends DefaultObject {
    ...
    public List<Object> getWebContainers() throws Exception {
        ...
        DocumentModelList webSites = session.query("SELECT * FROM Document WHERE ecm:mixinType = 'WebView'  "
                + " AND webc:isWebContainer = 1 AND ecm:currentLifeCycleState != 'deleted'");
