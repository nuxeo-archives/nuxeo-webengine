...
"%JAVA%" %JAVA_OPTS% -jar nuxeo-runtime-launcher-1.5.m3.jar bundles/nuxeo-runtime-osgi-1.5.m3.jar/org.nuxeo.osgi.application.Main bundles/.:lib/.:config -bundles=bundles/nuxeo-shell-commands-base.jar@3 -home . %*
